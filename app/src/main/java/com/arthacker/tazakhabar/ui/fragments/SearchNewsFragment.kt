...
import com.arthacker.tazakhabar.util.Constants
import com.arthacker.tazakhabar.util.Constants.Companion.QUERY_PAGE_SIZE
import com.arthacker.tazakhabar.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            // at least as many items in our recycler view than query page size
